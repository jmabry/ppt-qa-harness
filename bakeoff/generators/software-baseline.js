...
async function buildDeck() {
  ...
  // ══════════════════════════════════════════════════════════════════════════
  {
    ...
    ], 1.22, [2.50, 0.98, 0.84, 0.98, 4.24], C.navy, 0.268, false, 9);
    ...
    s.addText(
      ...
      { x: LM+0.10, y: 4.62, w: CW-0.20, h: 0.44,
        fontSize: 9, color: C.navy, fontFace: "Calibri", margin: 0, valign: "middle" }
    );
  }
  ...
  await pres.writeFile({ fileName: "outputs/software-baseline.pptx" });
  console.log("✅  Wrote outputs/software-baseline.pptx");
}
